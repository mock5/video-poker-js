...
const doubleBonusPayTable = {
  ROYAL_FLUSH: [250, 500, 750, 1000, 4000],
  STRAIGHT_FLUSH: [50, 100, 150, 200, 250],
  FOUR_OF_A_KIND: [160, 320, 480, 640, 800], // Much higher payout for four of a kind
  FULL_HOUSE: [10, 20, 30, 40, 50],
  FLUSH: [7, 14, 21, 28, 35],
...
function DoubleBonusGame() {
  ...
  const handleDeal = () => {
    if (gamePhase === 'betting' || gamePhase === 'gameOver') {
      ...
      setTimeout(() => {
        ...
        // Calculate winnings using Double Bonus pay table
        const win = doubleBonusPayTable[result.type][currentBet - 1];
        setWinAmount(win);
  ...
  return (
    <div className="video-poker">
      <h1>Double Bonus Poker</h1>

      <PayTable
        currentBet={currentBet}
        currentHandType={handResult.type}
        customPayTable={doubleBonusPayTable}
      />
...
export default DoubleBonusGame;
